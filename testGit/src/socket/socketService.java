...
public class socketService {
    ...
    public  void oneServer(){
        try{
            ...
            BufferedReader br=new BufferedReader(new InputStreamReader(byteUnilts.StringTOInputStream(out)));
            //由系统标准输入设备构造BufferedReader对象
//            System.out.println("Client:"+byteUnilts.InputStreamTOString((socket.getInputStream())));
            ...
            //如果该字符串为 "bye"，则停止循环
                ...
                //在系统标准输出上打印读入的字符串
                System.out.println("Client:"+in.readLine());
//                System.out.println("Client:"+Arrays.toString(in.readLine().getBytes()));
